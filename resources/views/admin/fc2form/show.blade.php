                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered mb-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>:<a href="{{ route('fc2PdfDownload',$dataFromFc2Form->id) }}" target="_blank" class="btn btn-success">View</a></td>
                                        </tr>
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td>:<a href="{{ route('verified_fc_two_form',$dataFromFc2Form->id) }}" target="_blank" class="btn btn-success">View</a></td>
                                        </tr>
                                    </table>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered mb-4">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('fc2fd2PdfDownload',$fd2FormList->id) }}" target="_blank" class="btn btn-success">View</a></td>
                                        </tr>
                                    </table>
                                    <table class="table table-bordered mb-4">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('fc2fd2OtherPdfDownload',$fd2OtherInfoAll->id) }}" target="_blank" class="btn btn-success">View</a></td>
                                        </tr>
                                        @endforeach
                                    </table>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ route('statusUpdateForFc2') }}" method="post">
                                                @csrf
