...
$reg_name = DB::table('fd_one_forms')->where('user_id',$allPartiw1->user_id)->value('organization_name_ban');
    ...
    <tr>
        ...
        <td>: {{ $reg_name }}, {{ $allPartiw1->organization_address}}</td>
    </tr>
    ...
    <tr>
        ...
        <td>:
            <?php
$getNgoTypeForPdf =DB::table('ngo_type_and_languages')->where('user_id',$allPartiw1->user_id)->value('ngo_type');
            $mainNgoTypeRenew = DB::table('ngo_type_and_languages')->where('user_id',$allPartiw1->user_id)->value('ngo_type_new_old');

            $registrationNumberForOld = DB::table('ngo_type_and_languages')->where('user_id',$allPartiw1->user_id)->value('registration');
...
@else
          ...
          {{ App\Http\Controllers\Admin\CommonController::englishToBangla($allPartiw1->registration_number)}}
          @else
...
@endif
    ...
    <tr>
        ...
        <td>:          @if(!$getAllDataNew )
            ...
            @else
            {{ App\Http\Controllers\Admin\CommonController::englishToBangla($getAllDataNew ->nationality) }}
            @endif
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>:{{ $allPartiw1->address }},{{ App\Http\Controllers\Admin\CommonController::englishToBangla($getAllDataNew ->mobile) }} {{ App\Http\Controllers\Admin\CommonController::englishToBangla($allPartiw1->phone) }}, {{ $allPartiw1->email }}</td>
    </tr>
    <tr>
        <td></td>
        <td></td>
...
<table style=" margin-top: 15px;width:100%">
    ...
    <tr>
        <td style="text-align: right; padding-right: 14%" colspan="3"><img width="150" height="60" src="{{ $ins_url }}{{ $getAllDataNew->digital_signature}}"/></td>
    </tr>
    <tr>
        <td style="text-align: right; padding-right: 14%" colspan="3"><img width="150" height="60" src="{{ $ins_url }}{{ $getAllDataNew->digital_seal}}"/></td>
    </tr>
</table>
        ...
        <table style=" margin-top: 10px;width:100%">
            ...
            <tr>
                ...
                <td style="width:30%; text-align: left;">:
                    ...
                    {{ App\Http\Controllers\Admin\CommonController::englishToBangla(date('d/m/y', strtotime($getAllDataNew->created_at))) }}
                </td>
