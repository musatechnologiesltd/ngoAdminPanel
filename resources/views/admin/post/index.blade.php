...
@endif
    ...
    ->where('id',$decesionNameId)->where('status','fcTwo')->value('decision_list');
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fcTwo','id'=>$allStatusData->mainId]) }}';">পাঠান</button>
...
@endif
    ...
    ->where('id',$decesionNameId)->where('status','fdThree')->value('decision_list');
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fdThree','id'=>$allStatusData->mainId]) }}';">পাঠান</button>
