                        ...
                        ->where('id',$allStatusData->dak_detail_id)->where('status','registration')->value('decision_list');
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right;">
                                            ...
                                            <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'registration','id'=>$allStatusData->registration_status_id]) }}';">পাঠান</button>
                    ...
                    ->where('id',$allStatusData->dak_detail_id)->where('status','renew')->value('decision_list');
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;">
                                        ...
                                        @if($allStatusData->original_recipient == 1)
                                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'renew','id'=>$allStatusData->renew_status_id]) }}';">পাঠান</button>
                ...
                ->where('id',$allStatusData->dak_detail_id)->where('status','nameChange')->value('decision_list');
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">
                                    ...
                                    @if($allStatusData->original_recipient == 1)
                                    <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'nameChange','id'=>$allStatusData->name_change_status_id]) }}';">পাঠান</button>
            ...
            ->where('id',$allStatusData->dak_detail_id)->where('status','fdNine')->value('decision_list');
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;">
                                ...
                                @if($allStatusData->original_recipient == 1)
                                <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fdNine','id'=>$allStatusData->f_d_nine_status_id]) }}';">পাঠান</button>
        ...
        ->where('id',$allStatusData->dak_detail_id)->where('status','fdNineOne')->value('decision_list');
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            ...
                            @if($allStatusData->original_recipient == 1)
                            <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fdNineOne','id'=>$allStatusData->f_d_nine_one_status_id]) }}';">পাঠান</button>
    ...
    ->where('id',$allStatusData->dak_detail_id)->where('status','fdSix')->value('decision_list');
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        ...
                        @if($allStatusData->original_recipient == 1)
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fdSix','id'=>$allStatusData->fd_six_status_id]) }}';">পাঠান</button>
    ...
    ->where('id',$allStatusData->dak_detail_id)->where('status','fdSeven')->value('decision_list');
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        ...
                        @if($allStatusData->original_recipient == 1)
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fdSeven','id'=>$allStatusData->fd_seven_status_id]) }}';">পাঠান</button>
    ...
    ->where('id',$allStatusData->dak_detail_id)->where('status','fcOne')->value('decision_list');
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        ...
                        @if($allStatusData->original_recipient == 1)
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fcOne','id'=>$allStatusData->fc_one_status_id]) }}';">পাঠান</button>
    ...
    ->where('id',$allStatusData->dak_detail_id)->where('status','fcTwo')->value('decision_list');
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        ...
                        @if($allStatusData->original_recipient == 1)
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fcTwo','id'=>$allStatusData->fc_two_status_id]) }}';">পাঠান</button>
     ...
     ->where('id',$allStatusData->dak_detail_id)->where('status','fdThree')->value('decision_list');
                 ...
                 <tr>
                     ...
                     <td style="text-align:right;">
                         ...
                         @if($allStatusData->original_recipient == 1)
                         <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fcTwo','id'=>$allStatusData->fd_three_status_id]) }}';">পাঠান</button>
