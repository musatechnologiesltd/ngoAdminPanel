...
$getngoForLanguage = DB::table('ngo_type_and_languages')->where('user_id',$formOneData->user_id)->value('ngo_type');
    ...
    <tr>
        ...
        <td>:
            ...
            <button  href="{{ route('formOnePdf',['main_id'=>$formOneData->id,'id'=>'plan']) }}" class="btn btn-outline-secondary" id="attLink1"  data-name="পরিচালন পরিকল্পনা"><i class="fa fa-paperclip"></i> সংযুক্তি </button>
            <button  href="{{ route('formOnePdf',['main_id'=>$formOneData->id,'id'=>'plan']) }}" class="btn btn-outline-danger" id="copyLink1"><i class="fa fa-copy"></i> কপি করুন </button>
    ...
    <tr>
        ...
        <button  href="{{ route('sourceOfFund',$allGetAllSourceOfFundData->id ) }}" class="btn btn-outline-secondary" id="attLink1"  data-name="দাতা /দাতাসংস্থার অঙ্গীকারপত্রের কপি"><i class="fa fa-paperclip"></i> সংযুক্তি </button>
        <button  href="{{ route('sourceOfFund',$allGetAllSourceOfFundData->id ) }}" class="btn btn-outline-danger" id="copyLink1"><i class="fa fa-copy"></i> কপি করুন </button>
    ...
    <tr>
        ...
        <td>:  @if(empty($formOneData->attach_the__supporting_paper))
            ...
            <button  href="{{ route('formOnePdf',['main_id'=>$formOneData->id,'id'=>'invoice']) }}" class="btn btn-outline-secondary" id="attLink1"  data-name="নিবন্ধন ফি ও ভ্যাট পরিশোধ চালানের কপি"><i class="fa fa-paperclip"></i> সংযুক্তি </button>
            <button  href="{{ route('formOnePdf',['main_id'=>$formOneData->id,'id'=>'invoice']) }}" class="btn btn-outline-danger" id="copyLink1"><i class="fa fa-copy"></i> কপি করুন </button>
