...
class ExecutiveCommitteeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $all_data_for_new_list = DB::table('document_for_executive_committee_approvals')->latest()->get();
            ...
            $ngoStatusNameChange = ExecutiveCommitteeDak::where('status',1)
            ...
            $all_data_for_new_list = DB::table('document_for_executive_committee_approvals')
 ...
 if($checkOldorNew == 'Old'){
     ...
     $duration_list_all1 = DB::table('ngo_durations')->where('fd_one_form_id',$form_one_data->id)->value('ngo_duration_end_date');
        ...
        return view('admin.executiveCommittee.view',compact('getformOneId',
